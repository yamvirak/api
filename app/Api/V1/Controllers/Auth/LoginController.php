...
use Carbon\Carbon;
use App\POS\Bot\LineBot;
use App\POS\Bot\LineModel;
use App\POS\Bot\BotLineNotify;
...
class LoginController extends ApiController
{
    ...
    public function login(Request $request) {
        ...
        // camzzxczxclkasjdklajskldjalksjd
       ...
       $role = '';
        ...
        //================================================>>> Line Bot 
        // $botRes = LineBot::loginData($user);

        //================================================>>> Line Bot Using Notify
       //  $botRes = BotLineNotify::sendNotification($user);
